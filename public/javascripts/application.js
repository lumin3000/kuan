init = function(){
    $('image_uploader') && $('image_uploader').addEvent('change', function(){
        var tar = this;
        var info = $('image_status');
        tar.set('disabled', 'true');
        ...
        sendMultipleFiles({
            ...
            onerror:function(){
                info.innerHTML = "The file " + this.file.fileName + " is too big [" + size(this.file.fileSize) + "]";
